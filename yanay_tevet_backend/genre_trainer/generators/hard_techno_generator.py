...
_HIHATS = [
    ...
    _cfg('hihat', 'hihat', -14, '16n', 'MetalSynth',
         ...
         [], ['C4',_N,_N,'C4',_N,'C4',_N,_N,'C4',_N,'C4',_N,_N,'C4',_N,_N,'C4',_N,_N,'C4',_N,'C4',_N,_N,'C4',_N,'C4',_N,_N,'C4',_N,_N]),
    _cfg('hihat', 'hihat', -13, '16n', 'MetalSynth',
         ...
         [], ['C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4','C4']),
    _cfg('hihat', 'hihat', -15, '16n', 'MetalSynth',
         {'frequency': 600, 'envelope': {'attack': 0.001, 'decay': 0.028, 'release': 0.012}, 'harmonicity': 5.8, 'modulationIndex': 40, 'resonance': 6000, 'octaves': 1.7},
         [_dist(0.3, 0.25)],
...
_BASSES = [
    ...
    _cfg('bass', 'bass', -6, '8n', 'MonoSynth',
         {'oscillator': {'type': 'sawtooth'}, 'envelope': {'attack': 0.004, 'decay': 0.07, 'sustain': 0.55, 'release': 0.18}, 'filterEnvelope': {'attack': 0.004, 'decay': 0.055, 'sustain': 0.35, 'release': 0.16, 'baseFrequency': 140, 'octaves': 4.8}},
         [_dist(0.65, 0.58), _filt('lowpass', 1500, 4)],
         ['G1',_N,'G1','G1','Ab1','G1',_N,'G1','F1',_N,'G1','F1','Eb1','F1',_N,'G1','G1',_N,'G1','Bb1','G1','Ab1',_N,'G1','F1',_N,'Eb1','F1','G1',_N,_N,'F1']),
]
...
_LEADS = [
    ...
    _cfg('industrial_stab', 'lead', -14, '16n', 'Synth',
         {'oscillator': {'type': 'square'}, 'envelope': {'attack': 0.001, 'decay': 0.06, 'sustain': 0.0, 'release': 0.04}},
         [_dist(0.75, 0.65)],
         ['A3',_N,_N,_N,_N,_N,_N,_N,'G3',_N,'A3',_N,_N,_N,_N,_N,'A3',_N,_N,_N,_N,_N,'G3',_N,'A3',_N,_N,'G3','E3',_N,_N,_N]),
    _cfg('industrial_stab', 'lead', -16, '16n', 'AMSynth',
         {'harmonicity': 3, 'envelope': {'attack': 0.001, 'decay': 0.1, 'sustain': 0.0, 'release': 0.08}, 'modulationEnvelope': {'attack': 0.2, 'decay': 0.05, 'sustain': 0, 'release': 0.06}},
         [_dist(0.5, 0.5), _reverb(0.4, 0.2)],
         [_N,_N,_N,_N,'E3',_N,_N,_N,_N,_N,_N,_N,'E3',_N,'D3',_N,_N,_N,_N,_N,'E3',_N,_N,_N,_N,_N,_N,_N,'E3',_N,'D3',_N]),
]
