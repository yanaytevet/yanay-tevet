...
_LEADS = [
    _cfg('lead', 'lead', -10, '16n', 'Synth',
         ...
         [_reverb(3.5, 0.7, 0.04), _delay('8n.', 0.35, 0.25)],
         ['A4',_N,_N,'C5','E5',_N,'D5',_N,'C5',_N,_N,'A4','G4',_N,_N,'E4','A4',_N,_N,'C5','E5',_N,'G5','F5','E5',_N,'D5',_N,'C5',_N,_N,_N]),
    _cfg('lead', 'lead', -11, '16n', 'Synth',
         {'oscillator': {'type': 'sawtooth'}, 'envelope': {'attack': 0.008, 'decay': 0.28, 'sustain': 0.38, 'release': 0.75}},
         [_reverb(4.0, 0.72, 0.05), _delay('8n.', 0.32, 0.22)],
         ['E5',_N,_N,'G5','B5',_N,'A5',_N,'G5',_N,_N,'E5','D5',_N,_N,'B4','E5',_N,_N,'G5','B5',_N,'D6','C6','B5',_N,'A5',_N,'G5',_N,_N,_N]),
    _cfg('lead', 'lead', -10, '16n', 'FMSynth',
         ...
         ['D5',_N,_N,'F5','A5',_N,'G5',_N,'F5',_N,_N,'D5','C5',_N,_N,'A4','D5',_N,_N,'F5','A5',_N,'C6','A5','G5',_N,'F5',_N,'E5',_N,_N,_N]),
    _cfg('lead', 'lead', -11, '16n', 'Synth',
         ...
         ['B4',_N,_N,'D5','G5',_N,'F#5',_N,'E5',_N,_N,'C5','B4',_N,_N,'G4','B4',_N,_N,'D5','G5',_N,'A5','G5','F#5',_N,'E5',_N,'D5',_N,_N,_N]),
]
...
class MelodicTechnoTrackGenerator(BaseTrackGenerator):
    ...
    def _generate_layers(cls) -> list[dict[str, Any]]:
        layers = [cls._pick(_KICKS), cls._pick(_HIHATS), cls._pick(_BASSES), cls._pick(_PADS)]
        clap = cls._maybe(_CLAPS, 0.6)
        if clap:
            layers.append(clap)
        lead = cls._maybe(_LEADS, 0.55)
        if lead:
            layers.append(lead)
        return layers
