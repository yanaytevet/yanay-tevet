...
class ItineraryTask(models.Model):
    if TYPE_CHECKING:
        id: int
    ...
    itinerary_list = models.ForeignKey(ItineraryList, on_delete=models.CASCADE, related_name='tasks')
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='created_itinerary_tasks')
    ...
    def __str__(self) -> str:
        return f'ItineraryTask({self.id}) - {self.name}'
